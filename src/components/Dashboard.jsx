...
const Dashboard = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      {user && (
        <div>
          <div className="hidden md:block fixed top-16 left-0 h-[calc(100%-64px)] w-52 bg-white shadow z-30">
            <Sidebar />
          </div>
          ...
          {isSidebarOpen && (
            <>
              <div
                ...
                />
              <div className="fixed inset-y-0 left-0 w-64 z-40 bg-white shadow-lg md:hidden">
                <Sidebar />
              </div>
            </>
          )}
